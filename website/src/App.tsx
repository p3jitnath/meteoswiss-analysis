  ...
  return (
    <>
      <header className="site-header">
        <nav className="topbar"><a className="identity" href="#top" aria-label="Swiss Climate Analysis home"><span className="identity-mark">ETH Zürich</span><span className="identity-unit"><b>Climate analysis</b><small>Independent research reproduction</small></span></a><div className="nav-links"><a href="#findings">Findings</a><a href="#methods">Methods</a><a href="#data">Data</a><a className="code-link" href="https://github.com/p3jitnath/meteoswiss-analysis" aria-label="View source code on GitHub"><GitHubMark /><span>Code</span></a></div></nav>
      </header>
