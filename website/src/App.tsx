...
export default function App() {
  ...
  return (
    <>
      ...
      <footer><span className="footer-meta"><span>Date retrieved: {season.summary.as_of}</span><span>Source: <a href="https://www.meteoswiss.admin.ch/" target="_blank" rel="noreferrer">MeteoSwiss</a></span><span className="license-note">Code licensed under MIT</span></span><span className="footer-links"><a href="https://github.com/p3jitnath/meteoswiss-analysis/blob/main/LICENSE" target="_blank" rel="noreferrer">MIT licence</a><a className="footer-code" href="https://github.com/p3jitnath/meteoswiss-analysis" target="_blank" rel="noreferrer"><GitHubMark /> Source code</a></span></footer>
    </>
  );
}
